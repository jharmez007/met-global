...
const StandardHeader02 = () => {
  return (
    <section
      className="bg-fixed relative min-h-[70vh] flex items-start pt-30 pb-20 md:pb-40 px-[3%] text-white bg-cover bg-bottom"
      style={{ backgroundImage: "url('/freight-bg.jpg')" }}
    >
      {/* Overlay */}
...
export default StandardHeader02;
